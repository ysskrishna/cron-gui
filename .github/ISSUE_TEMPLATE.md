...
- [ ] The `node_modules` folder has right permissions (Run `ls -ld $(npm root -g)/cron-gui`)
- [ ] Read [issues.md](https://github.com/ysskrishna/cron-gui/blob/main/docs/issues.md)
